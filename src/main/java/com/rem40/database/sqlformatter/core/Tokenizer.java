package com.rem40.database.sqlformatter.core;

import com.rem40.database.sqlformatter.core.util.JSLikeList;
import com.rem40.database.sqlformatter.core.util.RegexUtil;
import com.rem40.database.sqlformatter.core.util.Util;
...
public class Tokenizer {
   ...
   *     cfg.reservedNewlineWords Words that are set to newline {String[]}
   *     cfg.stringTypes String types to enable: "", "", ``, [], N"" {String[]}
   *     cfg.openParens Opening parentheses to enable, like (, [ {String[]}
   *     cfg.closeParens Closing parentheses to enable, like ), ] {String[]}
   *     cfg.indexedPlaceholderTypes Prefixes for indexed placeholders, like ? {String[]}
